...
try:
        ...
        def run(self):
            ...
            while True:
                ...
                if self.window.img_queue.empty():
                    ...
                    self.window.download_left_label.config(text=self.window.img_queue.qsize())
            ...
            while True:
                ...
                if self.window.img_num == len(self.window.present_page):
                    try:
                        ...
                        self.window.present_page = requests.get(base_url.format(site, tag,self.window.present_page_num+1))\
                                                                                                                    .json()
    ...
    class Window:
        ...
        def __init__(self):
            ...
            self.download_left_label = Label(self.top,text='0')
            ...
            self.next_button = Button(self.top,text='下载此图',width=8,command = self.download_present_page)
            self.download_button = Button(self.top,text='下一张图',width=8,command = self.get_next_page)
        ...
        def download_present_page(self):
            ...
            self.download_left_label.config(text=self.img_queue.qsize())
            self.get_next_page()
